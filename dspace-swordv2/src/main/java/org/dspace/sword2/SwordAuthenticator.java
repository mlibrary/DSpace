...
public class SwordAuthenticator {
     ...
     * @throws SwordAuthException   thrown if unable to authenticate
     */
        ...
        try {
            ...
            if (this.authenticates(context, un, pw)) {
                ...
                if (ep != null) {
                    ...
                    log.info("OIDC: getSpecialGroups authenticate");
                ...
                if (obo != null) {
                    ...
                    if (epObo != null) {
                        ...
                        // Set any special groups - invoke the authentication mgr.
                        log.info("OIDC: getSpecialGroups auth 2 ");
                        List<Group> specialGroups = authenticationService
     ...
     *
     * @param swordContext The relevant SWORD Context.
     * @param community    parent community to check recursively
     * @return the array of allowed collections
     * @throws DSpaceSwordException can be thrown by the internals of the DSpace SWORD implementation
     */
